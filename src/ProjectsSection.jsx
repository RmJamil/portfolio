...
const projects = [
  {
    ...
    liveLink: 'https://auction-gallery.surge.sh/',
    githubLink: 'https://github.com/RmJamil/auctionGallery',
  },
  {
    id:2,
    ...
    liveLink: 'https://hotel-booking-client-b0a32.web.app',
    githubLink: 'https://github.com/RmJamil/hotel-book',
  },
  {
    id:3,
    ...
    liveLink: 'https://jetwork-d8354.web.app',
    githubLink: 'https://github.com/RmJamil/freelance-market-client',
  },
  {
    id:4,
    ...
    skills: [<SiReact className="text-blue-500" />, <SiFirebase className="text-yellow-500" />, <SiTailwindcss className="text-teal-400" />],
    liveLink: 'https://jetwork-d8354.web.app',
    githubLink: 'https://github.com/RmJamil/app-store',
  },
];

const ProjectsSection = () => {
  return (
    <section id='projects' className="py-12  rounded-2xl my-6 relative">
     ...
     data-aos-duration="700"
              key={index}
              className=" border-1 border-blue-500 p-2 rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105 "
            >
              <img
                src={project.image}
                alt={project.name}
              ...
              <div className="p-4">
                ...
                <div className="flex space-x-4">
                  <a href={project.liveLink} target="_blank" rel="noopener noreferrer" className="flex items-center  hover:text-blue-700">
                    <FaExternalLinkAlt className="mr-2" /> Live
                  </a>
                  <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="flex items-center  hover:text-black">
                    <FaGithub className="mr-2" /> GitHub
                  </a>
                 <div className='absolute bottom-1 right-1'><button className='p-1 px-4 rounded-xl cursor-pointer hover:bg-blue-500 hover:text-white border-2 border-blue-400'> <Link to={`/details/${project.id}`}>View details</Link></button></div>
                </div>
              </div>
            </div>
          ))}
